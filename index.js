 ...
 * @param {string} [opts.username=process.env.GETSMSCODE_USERNAME] - Username for wahlburger auth
 * @param {string} [opts.token=process.env.GETSMSCODE_TOKEN] - Token for wahlburger auth
...
class GetSMSCodeClient {
  constructor (opts = { }) {
    ...
    if (!suffix) throw new Error(`unknown wahlburger domain "${domain}"`)

    this._url = `http://www.wahlburger.com/${suffix}.php`
